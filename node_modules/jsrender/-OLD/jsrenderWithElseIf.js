...
//					if (tagName !== ELSEIF && params) {
//						syntaxError("Use {{else}} or {{elseif " + params + "}}");
//					}
//					current[5] = markup.substring(current[5], index); // contentMarkup for block tag
//					current = stack.pop();
//					content = current[3];
...
//				}
				...
				current0 = current[0];
//				blockTagCheck(closeBlock !== current0 && !(closeBlock === "if" && (current0 === "else" || current0 === ELSEIF)) && current0);
...
//		ELSEIF: function() {
//			var view = this.view;
//			return view.onElse ? view.onElse(this, arguments.length ? arguments : [false]) : "";
//		},
		"else": function() {
			var view = this.view;
